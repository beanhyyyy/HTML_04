  ...
  })(
    {
        ...
        function (a, b, c) {
          ...
          b.exports = function (a, b) {
            ...
            c && (b.dumpLineNumbers = c[1]),
              ...
              (b.javascriptEnabled = !(
                !b.javascriptEnabled && !b.inlineJavaScript
              ));
          };
        },
        { "./browser": 3, "./utils": 11 },
          ...
          b.exports = function (b, c) {
            ...
            function i(a, b, e, g, h) {
              ...
              d(j, a),
                (j.mime = a.type),
                h && (j.modifyVars = h),
                p.loadFile(a.href, null, j, n, function (a, c) {
                  return a ? void b(a) : void i(c);
                });
            }
            function j(a, b, c) {
      ...
      10: [
        function (a, b, c) {
          ...
          (e.prototype = new d()),
            (e.prototype.tryLoadPlugin = function (a, b, c) {
              var d = this,
                e = a.slice(0, 1),
                f =
                  "." === e || "/" === e || ".js" === a.slice(-3).toLowerCase();
              this.tryLoadFromEnvironment(a, b, f, function (e, g) {
                f
                  ? c(e, g)
                  : e
                  ? d.tryLoadFromEnvironment(
                      "less-plugin-" + a,
                      b,
                      f,
                      function (a, b) {
            ...
            (e.prototype.tryLoadFromEnvironment = function (a, b, c, d) {
              var e = new this.less.FileManager();
              if ((b && (a = e.extractUrlParts(a, b).url), a)) {
                a = e.tryAppendExtension(a, ".js");
                var f = function (a, b) {
                  a ? d(a) : d(null, b);
                };
                e.loadFile(a, null, null, null, f);
              } else d({ message: "Plugin could not be found." });
            }),
            (b.exports = e);
        },
      ...
      17: [
        function (a, b, c) {
          ...
          (g.prototype.evalPlugin = function (a, b, c, d) {
            var f, g, h, i, j, k, l;
            (k = b.pluginManager),
              d && (l = "string" == typeof d ? d : d.filename);
            var m = new this.less.FileManager().extractUrlParts(l).filename;
            if (l && (h = k.get(l)))
              return (
                this.trySetOptions(h, l, m, c),
                h.use && h.use.call(this.context, h),
                h
              );
            (i = { exports: {}, pluginManager: k, fileInfo: d }),
              (j = i.exports),
              (g = e.create());
            try {
              if (
                ...
                (h = f(i, this.require, g, this.less.tree, d)),
                h || (h = i.exports),
                (h = this.validatePlugin(h, l, m)),
                !h)
              )
                return new this.less.LessError({
                  message: "Not a valid plugin",
                });
              k.addPlugin(h, d.filename, g),
                (h.functions = g.getLocalFunctions()),
                this.trySetOptions(h, l, m, c),
                h.use && h.use.call(this.context, h);
            } catch (n) {
              return (
                console.log(n.stack),
                new this.less.LessError({
                  message:
            ...
            (g.prototype.trySetOptions = function (a, b, c, e) {
              if (e) {
                ...
                try {
                  ...
                  return (
                    d(
                      "Error setting options on plugin " + c + "\n" + f.message
                    ),
                    null
                  );
                }
          ...
          (h = {
            ...
            contrast: function (a, b, c, d) {
              ...
              var e,
                ...
                j = c.luma();
              return (
                (e = g > i ? (g + 0.05) / (i + 0.05) : (i + 0.05) / (g + 0.05)),
                (f = g > j ? (g + 0.05) / (j + 0.05) : (j + 0.05) / (g + 0.05)),
                e > f ? b : c
              );
            },
            argb: function (a) {
            ...
            h.add("svg-gradient", function (a) {
              function b() {
                throw {
                  type: "Argument",
                  message:
                    "svg-gradient expects direction, start_color [start_position], [color position,]...,<br /> end_color [end_position] or direction, color list",
                };
              }
              var h,
                i,
          ...
          b.exports = function (a) {
            ...
            return (
              (b.prototype.push = function (b, c, g, h, i) {
                var j = this,
                  k = this.context.pluginManager.Loader;
                this.queue.push(b);
                var l = function (a, c, d) {
                  ...
                  n = a.getFileManager(b, g.currentDirectory, this.context, a);
                if (!n)
                  return void l({
                    message: "Could not find a file-manager for " + b,
                  });
                c && (b = h.isPlugin ? b : n.tryAppendExtension(b, ".less"));
                var o,
                  p = function (a) {
                    var b,
                      c = a.filename,
                      i = a.contents.replace(/^\uFEFF/, "");
                    (m.currentDirectory = n.getPath(c)),
                      m.relativeUrls &&
                        ((m.rootpath = n.join(
                          j.context.rootpath || "",
                          n.pathDiff(m.currentDirectory, m.entryPath)
                        )),
                        !n.isPathAbsolute(m.rootpath) &&
                          n.alwaysMakePathsAbsolute() &&
                          (m.rootpath = n.join(m.entryPath, m.rootpath))),
                      (m.filename = c);
                    var o = new d.Parse(j.context);
                    (o.processImports = !1),
                      (j.contents[c] = i),
                      (g.reference || h.reference) && (m.reference = !0),
                      h.isPlugin
                        ? ((b = k.evalPlugin(i, o, h.pluginArgs, m)),
                          b instanceof f ? l(b, null, c) : l(null, b, c))
                        : h.inline
                        ? l(null, i, c)
                        : new e(o, j, m).parse(i, function (a, b) {
                            l(a, b, c);
                          });
                  },
                  q = function (a, b) {
                ...
                if (h.isPlugin)
                  try {
                    k.tryLoadPlugin(b, g.currentDirectory, q);
                  } catch (r) {
                    i(r);
                  }
                else
                  (o = n.loadFile(b, g.currentDirectory, this.context, a, q)),
                    o && o.then(p, l);
              }),
              b
            );
      ...
      37: [
        function (a, b, c) {
          var d,
            ...
            g = a("./plugin-manager"),
            h = a("./less-error");
          b.exports = function (b, c, i) {
            var j = function (b, c, k) {
              if (
                ((c = c || {}),
              ...
              var m,
                n,
                o = new g(this, !0);
              if (((c.pluginManager = o), (m = new e.Parse(c)), c.rootFileInfo))
                n = c.rootFileInfo;
              else {
                var p = c.filename || "input",
                  q = p.replace(/[^\/\\]*$/, "");
                (n = {
                  filename: p,
              ...
              var r = new i(this, m, n);
              (this.importManager = r),
                c.plugins &&
                  c.plugins.forEach(function (a) {
                    ...
                    if (a.fileContent) {
                      if (
                        ...
                        (b = o.Loader.evalPlugin(c, m, a.options, a.filename)),
                        b instanceof h)
                      )
                        return k(b);
                    } else o.addPlugin(a);
                ...
                new f(m, r, n).parse(
                  b,
                  function (a, b) {
                    return a ? k(a) : void k(null, b, r, c);
                  },
                  c
                );
            };
              ...
              return {
                ...
                parsers: (n = {
                      ...
                      for (o.save(); ; ) {
                        ...
                        if (
                          (a
                            ...
                            : (r = h),
                          r &&
                            (r instanceof e.Variable ||
                              r instanceof e.Property))
                        )
                          if (o.$char(":")) {
                            if (
                              (m.length > 0 &&
                  ...
                  declaration: function () {
                    ...
                    if ("." !== i && "#" !== i && "&" !== i && ":" !== i)
                      if (
                        (o.save(), (a = this.variable() || this.ruleProperty()))
                      ) {
                        if (
                          ((g = "string" == typeof a),
                          g && (b = this.detachedRuleset()),
                          (o.commentStore.length = 0),
                          !b)
                        ) {
                          if (
                            ((f = !g && a.length > 1 && a.pop().value),
                            (b = this.anonymousValue()))
                          )
                            return (
                              o.forget(), new e.Declaration(a, b, !1, f, h, c)
                            );
                          b || (b = this.value()), (d = this.important());
                        }
                        if (b && this.end())
                          return (
                            o.forget(), new e.Declaration(a, b, d, f, h, c)
                          );
                        o.restore();
                      } else o.restore();
                  },
                  ...
                  plugin: function () {
                    ...
                    if (g) {
                      if (
                        ...
                        return (
                          o.$char(";") ||
                            ((o.i = f), i("missing semi-colon on @plugin")),
                          new e.Import(a, null, d, f, c)
                        );
                      (o.i = f), i("malformed @plugin statement");
                    }
                  },
                  pluginArgs: function () {
                      ...
                      if ((o.save(), (b = o.$re(/^@[a-z-]+/)))) {
                        ...
                        return (
                          ...
                          f || (!n && d && o.$char(";"))
                            ...
                            : void o.restore("at-rule options not recognised")
                        );
                      }
                    }
                  },
      ...
      41: [
        function (a, b, c) {
          ...
          var e,
            ...
            g = function (a, b) {
              return (!b && e) || (e = new f(a)), e;
            };
          (f.prototype.addPlugins = function (a) {
            if (a) for (var b = 0; b < a.length; b++) this.addPlugin(a[b]);
          }),
            (f.prototype.addPlugin = function (a, b, c) {
            ...
            Object.getPrototypeOf ||
              (Object.getPrototypeOf = function (a) {
                return a.constructor ? a.constructor.prototype : void 0;
              }),
            (f.prototype.addVisitor = function (a) {
              var b;
              try {
                (b = Object.getPrototypeOf(a)),
                  d(b, "Directive", "AtRule"),
                  d(b, "Rule", "Declaration");
              } catch (c) {}
              this.visitors.push(a);
            }),
            (f.prototype.addPreProcessor = function (a, b) {
              var c;
              for (
                c = 0;
            ...
            (f.prototype.addPostProcessor = function (a, b) {
              var c;
              for (
                c = 0;
            ...
            (f.prototype.getFileManagers = function () {
      ...
      45: [
        function (a, b, c) {
          ...
          b.exports = function (a, b) {
            ...
            if (b.pluginManager)
              for (j = b.pluginManager.visitor(), j.first(); (i = j.get()); )
      ...
      49: [
        ...
        { "./node": 73, "./ruleset": 80, "./selector": 81 },
      ],
      50: [
        function (a, b, c) {
          var d = a("./node"),
          ...
          (g.prototype = new d()),
            ...
            (g.prototype.eval = function (a) {
              ...
              if (h.isValid()) {
                ...
                if (null !== b && void 0 !== b)
                  return (
                    b instanceof d || (b = new e(null)),
                    (b._index = this._index),
                    (b._fileInfo = this._fileInfo),
                    b
                  );
              }
              ...
              try {
                ...
                throw (
                  ("number" != typeof k.index &&
                    ((k.index = this.getIndex()),
                    (k.filename = this.fileInfo().filename)),
                  k)
                );
              } finally {
                c && (a.strictMath = !1);
      ...
      64: [
        function (a, b, c) {
          ...
          (k.prototype = new d()),
            ...
            (k.prototype.doEval = function (a) {
              var b,
                c,
                d = this.features && this.features.eval(a);
              if (this.options.isPlugin)
                return (
                  this.root && this.root.eval && this.root.eval(a),
              ...
              if (this.css) {
                var g = new k(this.evalPath(a), d, this.options, this._index);
        ...
        function (a, b, c) {
          var d = a("./selector"),
            ...
            k = function (a, b, c, f, g, h, i) {
              (this.name = a),
                (this.selectors = [
                  new d([new e(null, a, this._index, this._fileInfo)]),
                ]),
                (this.params = b),
                (this.condition = f),
                (this.variadic = g),
          ...
          (k.prototype = new f()),
            (k.prototype.type = "MixinDefinition"),
            (k.prototype.evalFirst = !0),
            (k.prototype.accept = function (a) {
              this.params &&
                this.params.length &&
            ...
            (k.prototype.evalParams = function (a, b, c, d) {
              ...
              if (
                (b.frames &&
                  ...
                  (r.functionRegistry = b.frames[0].functionRegistry.inherit()),
                (b = new i.Eval(b, [r].concat(b.frames))),
                c)
              )
                for (c = j.copyArray(c), t = c.length, l = 0; l < t; l++)
                  if (((k = c[l]), (o = k && k.name))) {
                    for (p = !1, m = 0; m < s.length; m++)
                      if (!d[m] && o === s[m].name) {
                        (d[m] = k.value.eval(a)),
                          r.prependRule(new g(o, k.value.eval(a))),
                          (p = !0);
                        break;
                      }
                    if (p) {
            ...
            (k.prototype.eval = function (a) {
              return new k(
                ...
                this.condition,
                this.variadic,
                this.frames || j.copyArray(a.frames)
              );
            }),
            (k.prototype.evalCall = function (a, b, c) {
              ...
              return (
                m.prependRule(new g("@arguments", new h(k).eval(a))),
                (d = j.copyArray(this.rules)),
                (e = new f(null, d)),
                (e.originalRuleset = this),
                (e = e.eval(new i.Eval(a, [this, m].concat(l)))),
                c && (e = e.makeImportant()),
                e
              );
            }),
      ...
      77: [
        function (a, b, c) {
          ...
          (h.prototype = new e()),
            ...
            (h.prototype.containsVariables = function () {
            ...
            (h.prototype.eval = function (a) {
              ...
              var c = this,
                ...
                i = function (b, d) {
                  ...
                  return e instanceof h ? e.value : e.toCSS();
                },
                j = function (b, d) {
                  var e = new g("$" + d, c.getIndex(), c.fileInfo()).eval(
                    a,
                    !0
                  );
                  return e instanceof h ? e.value : e.toCSS();
      ...
      80: [
        function (a, b, c) {
          ...
          (r.prototype = new d()),
            (r.prototype.type = "Ruleset"),
            (r.prototype.isRuleset = !0),
            (r.prototype.isRulesetLike = function () {
              return !0;
            }),
            (r.prototype.accept = function (a) {
              this.paths
            ...
            (r.prototype.eval = function (a) {
              ...
              var j,
                k,
                l = this.rules ? q.copyArray(this.rules) : null,
                o = new r(b, l, this.strictImports, this.visibilityInfo());
              ...
              for (g = 0; (j = t[g]); g++)
                "MixinCall" === j.type
                  ? ((l = j.eval(a).filter(function (a) {
                      return (
                        !(a instanceof e && a.variable) || !o.variable(a.name)
                      );
                    })),
                    t.splice.apply(t, [g, 1].concat(l)),
                    (g += l.length - 1),
                    o.resetCache())
                  : "RulesetCall" === j.type &&
                    ((l = j.eval(a).rules.filter(function (a) {
              ...
              for (g = 0; (j = t[g]); g++)
                if (
                  ...
                  t.splice(g--, 1);
                  for (var v = 0; (k = j.rules[v]); v++)
                    k instanceof d &&
                      (k.copyVisibilityInfo(j.visibilityInfo()),
                      (k instanceof e && k.variable) || t.splice(++g, 0, k));
                }
              if ((p.shift(), s.shift(), a.mediaBlocks))
                for (g = u; g < a.mediaBlocks.length; g++)
                  a.mediaBlocks[g].bubbleSelectors(b);
              return o;
            }),
            (r.prototype.evalImports = function (a) {
              var b,
                c,
                d = this.rules;
              if (d)
            ...
            (r.prototype.makeImportant = function () {
              var a = new r(
                this.selectors,
                this.rules.map(function (a) {
            ...
            (r.prototype.matchArgs = function (a) {
              return !a || 0 === a.length;
            }),
            (r.prototype.matchCondition = function (a, b) {
            ...
            (r.prototype.variables = function () {
              return (
                this._variables ||
            ...
            (r.prototype.variable = function (a) {
              var b = this.variables()[a];
              if (b) return this.parseValue(b);
            }),
            (r.prototype.property = function (a) {
              var b = this.properties()[a];
              if (b) return this.parseValue(b);
            }),
            (r.prototype.parseValue = function (a) {
              function b(a) {
                if (a.value instanceof k && !a.parsed) {
                  try {
                    this.parse.parserInput.start(
                      a.value.value,
                      !1,
                      function (b, c) {
                        return (a.parsed = !0), a;
                    ...
                    var b = this.parse.parsers.value(),
                      c = this.parse.parsers.important(),
                      d = this.parse.parserInput.end();
                    d.isFinished &&
                      ((a.value = b), (a.imporant = c), (a.parsed = !0));
                  } catch (e) {
                    throw new p(
                      {
                        index: e.index + a.value.getIndex(),
                        message: e.message,
                      },
                      this.parse.imports,
                      a.fileInfo().filename
            ...
            (r.prototype.prependRule = function (a) {
              var b = this.rules;
              b ? b.unshift(a) : (this.rules = [a]), this.setParent(a, this);
            }),
            (r.prototype.find = function (a, b, c) {
              b = b || this;
              var d,
                e,
                f = [],
            ...
            (r.prototype.genCSS = function (a, b) {
              var c,
                d,
                e,
                f,
            ...
            (r.prototype.joinSelectors = function (a, b, c) {
              for (var d = 0; d < c.length; d++) this.joinSelector(a, b, c[d]);
            }),
            (r.prototype.joinSelector = function (a, b, c) {
              function d(a, b) {
                var c, d;
              ...
              function e(a, b) {
                var c, d;
                return (
                  (c = new j(null, a, b._index, b._fileInfo)), (d = new i([c]))
                );
              }
              function f(a, b, c, d) {
                var e, f, g;
                if (
                  ...
                  a.length > 0
                    ? ((e = q.copyArray(a)),
                      (f = e.pop()),
                      (g = d.createDerived(q.copyArray(f.elements))))
                    : (g = d.createDerived([])),
                  b.length > 0)
                ) {
                  var h = c.combinator,
                  ...
                  h.emptyOrWhitespace &&
                    ...
                    (h = i.combinator),
                    g.elements.push(new j(h, i.value, c._index, c._fileInfo)),
                  ...
                  if ("&" !== u.value) {
                    ...
                    for (x = !0, s = [], k(q, r), o = 0; o < r.length; o++)
                      if (((t = r[o]), 0 === b.length))
                        t.length > 0 &&
                          t[0].elements.push(
                            new j(u.combinator, "", u._index, u._fileInfo)
                          ),
                          s.push(t);
                      else
          ...
          (f.prototype = new d()),
            ...
            (f.prototype.createEmptySelectors = function () {
              var a = new e("", "&", this._index, this._fileInfo),
                b = [new f([a], null, null, this._index, this._fileInfo)];
            ...
            (e.prototype.eval = function (a) {
              ...
              if (
                (0 === c.indexOf("@@") &&
                  (c =
                    "@" +
                    new e(c.slice(1), this.getIndex(), this.fileInfo()).eval(a)
                      .value),
                this.evaluating)
              )
                throw {
