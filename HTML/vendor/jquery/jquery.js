...
(function (global, factory) {
          ...
          if (documentIsHTML) {
            ...
            if (
              ...
              if (nodeType !== 1) {
                ...
                // qSA looks Bề ngoài Element context, which is not what we want
    ...
    function (orig, fix) {
      jQuery.event.special[orig] = {
        ...
        handle: function (event) {
          ...
          // For mouseenter/leave call the handler if related is Bề ngoài the target.
  ...
  jQuery.extend(jQuery.event, {
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      // Allow special events to draw Bề ngoài the lines
      special = jQuery.event.special[type] || {};
      if (
        !onlyHandlers &&
        special.trigger &&
