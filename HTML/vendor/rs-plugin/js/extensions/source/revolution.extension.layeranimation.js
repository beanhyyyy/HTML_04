  ...
  jQuery.extend(true, _R, {
	...
	***************************************/
    ...
    createFrameOnTimeline: function (obj) {
      ...
      if (_._nctype === "column") {
        timeline.add(
          punchgs.TweenLite.set(_._cbgc_man, { display: "block" }),
          label
        );
        timeline.add(
          punchgs.TweenLite.set(_._cbgc_auto, { display: "none" }),
          label
        );
      }
      ...
      var $to =
          frame_index !== _.outframeindex
            ? getAnimDatas(newAnimObject(), _.frames[frame_index].to)
        ...
        $from =
          _.frames[frame_index].from !== undefined
            ? getAnimDatas($to, _.frames[_.inframeindex].from, opt.sdir == 1)
      ...
      // ON START
      tweens.content.eventCallback(
        "onStart",
        function (frame_index, ncobj, pw, _, tl, toanim, _nc, ust) {
          var data = {};
          data.layer = _nc;
          data.eventtype =
            frame_index === 0
      ...
      tweens.content.eventCallback(
        "onUpdate",
        function (label, id, pw, _, tl, frame_index, toanim, ust) {
      ...
      tweens.content.eventCallback(
        "onComplete",
        function (frame_index, frame_max, verylastframe, pw, _, tl, ust) {
          var data = {};
          data.layer = _nc;
          data.eventtype =
            frame_index === 0
