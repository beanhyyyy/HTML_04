  ...
  jQuery.extend(!0, b, {
        ...
        (q = void 0 === q ? 0 : q),
          ...
          d._ingroup &&
            ...
            (void 0 !== q &&
              !jQuery.isNumeric(q) &&
              q.indexOf("%") > 0 &&
              punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minWidth: q }),
            void 0 !== t &&
              !jQuery.isNumeric(t) &&
              t.indexOf("%") > 0 &&
              punchgs.TweenLite.set([d._lw, d._pw, d._mw], { minHeight: t }));
      }
        ...
        for (var r = 0; r < d.frames.length; r++)
          if (r !== d.hoverframeindex) {
            ...
            (d.frames[r].framename = s),
              (k[s] = {}),
              (k[s].timeline = new punchgs.TimelineLite({ align: "normal" }));
    ...
    createFrameOnTimeline: function (a) {
      ...
      if (
        ...
        "column" === d._nctype &&
          (g.add(punchgs.TweenLite.set(d._cbgc_man, { display: "block" }), e),
          g.add(punchgs.TweenLite.set(d._cbgc_auto, { display: "none" }), e)),
      ...
      if (
        ...
        c.data("iframes") &&
          g.add(
            punchgs.TweenLite.set(c.find("iframe"), { autoAlpha: 1 }),
            e + "+=0.001"
          ),
        h === d.outframeindex &&
        ...
        o.content.eventCallback(
          ...
          function (a, d, e, f, g, h, i) {
            ...
            (k.layer = c),
              ...
              "column" === g._nctype &&
                (punchgs.TweenLite.set(g._cbgc_man, { display: "none" }),
                punchgs.TweenLite.set(g._cbgc_auto, { display: "block" })),
  ...
  var e = function (a, b) {
                ...
                case "move":
                  ...
                  (F =
                    F < G
                      ...
                      : F),
                    "vertical" === A
                      ? punchgs.TweenLite.set(z, { top: F + "px" })
                      : punchgs.TweenLite.set(z, { left: F + "px" });
                  break;
                case "end":
                case "cancel":
                  if (r)
    ...
    w = function (a, b, c, d, e) {
      ...
      u
        ...
        "vertical" === b.direction
          ? (u.css({ top: (w - 1) * y + "px", left: "0px" }),
            p.css({
              height: (w - 1) * y + u.outerHeight(),
              width: u.outerWidth(),
            }))
          : (u.css({ left: (w - 1) * x + "px", top: "0px" }),
            p.css({
  ...
  jQuery.extend(!0, b, {
    ...
    manageVideoLayer: function (a, g, i, j) {
      ...
      "none" != a.data("dottedoverlay") &&
        ...
        1 == a.data("bgvideo") &&
          punchgs.TweenLite.set(a.find("video, iframe"), { autoAlpha: 0 });
    },
  });
  var f = function (a, b, c) {
      a.addEventListener
        ? a.addEventListener(b, c, { capture: !1, passive: !0 })
        : a.attachEvent(b, c, { capture: !1, passive: !0 });
    },
    g = function (a, b, c) {
      var d = {};
